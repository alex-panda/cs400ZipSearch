 ...
 *          5: Exit the program.
 *      on loop until you decide to quit the program using option 5.
 */
public class CommandLineDriver {
  ...
  private final static String INVALID_COMMAND =
    ...
    private final static String MENU =
             "1: See if a zipcode exists in the database.\n"
           + "2: Input a zipcode and get its corresponding city, county, and state.\n"
           + "3: Add a zipcode to the database.\n"
           + "4: Exit the program.\n"
           + "Please enter a command:\n";

    /**
     * The main method that drives the application. When run, this method
     *      prompts the user for choices and inputs and displays the corresponding
    ...
    public static void main(String[] args) {
        ...
        while (true) {
		    ...
		    if(place == null){
			System.out.println("ERROR: Make sure the zipcode is in our database!");
		    }
		    else{
                        String placeStr = "";
                ...
                case '3': // 3: Add a zipcode to the database
                    ...
                    if(zipRBT.contains(zipcode)){
		    	System.out.println("ZipCode already in the database");
		    	break;
		    } 
